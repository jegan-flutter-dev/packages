...
func deepEqualsMessages(_ lhs: Any?, _ rhs: Any?) -> Bool {
    ...
    case (let lhsDictionary, let rhsDictionary)
        as ([AnyHashable: Any?], [AnyHashable: Any?]):
    ...
    if let cleanValue = cleanValue {
        if let doubleValue = cleanValue as? Double {
            ...
            for (key, value) in valueDict {
                ...
                result =
                    result
                    &+ ((entryKeyHasher.finalize() &* 31)
                        ^ entryValueHasher.finalize())
            }
...
struct MaxSize: Hashable {
    ...
    static func == (lhs: MaxSize, rhs: MaxSize) -> Bool {
        ...
        return deepEqualsMessages(lhs.width, rhs.width)
            && deepEqualsMessages(lhs.height, rhs.height)
    }
...
struct MediaSelectionOptions: Hashable {
    ...
    static func == (lhs: MediaSelectionOptions, rhs: MediaSelectionOptions)
        -> Bool
    {
        if Swift.type(of: lhs) != Swift.type(of: rhs) {
            return false
        ...
        return deepEqualsMessages(lhs.maxSize, rhs.maxSize)
            ...
            && deepEqualsMessages(
                lhs.requestFullMetadata,
                rhs.requestFullMetadata
...
struct SourceSpecification: Hashable {
    ...
    static func == (lhs: SourceSpecification, rhs: SourceSpecification) -> Bool
    {
        ...
        return deepEqualsMessages(lhs.type, rhs.type)
            && deepEqualsMessages(lhs.camera, rhs.camera)
    }
...
struct CoverageModel: Hashable {
    ...
    static func == (lhs: CoverageModel, rhs: CoverageModel) -> Bool {
        ...
        return deepEqualsMessages(lhs.list, rhs.list)
            && deepEqualsMessages(lhs.map, rhs.map)
    }
...
class ImagePickerApiSetup {
    ...
    static func setUp(
        ...
        let pickImageChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.image_picker_ios.ImagePickerApi.pickImage\(channelSuffix)",
        ...
        let pickMultiImageChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.image_picker_ios.ImagePickerApi.pickMultiImage\(channelSuffix)",
            binaryMessenger: binaryMessenger,
            codec: codec
        )
        if let api = api {
        ...
        let pickVideoChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.image_picker_ios.ImagePickerApi.pickVideo\(channelSuffix)",
            binaryMessenger: binaryMessenger,
            codec: codec
        )
        if let api = api {
            pickVideoChannel.setMessageHandler { message, reply in
                ...
                api.pickVideo(
                    source: sourceArg,
                    maxDurationSeconds: maxDurationSecondsArg
                ) { result in
                    switch result {
                    case .success(let res):
                        reply(wrapResult(res))
        ...
        let pickMultiVideoChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.image_picker_ios.ImagePickerApi.pickMultiVideo\(channelSuffix)",
            binaryMessenger: binaryMessenger,
            codec: codec
        )
        if let api = api {
        ...
        let pickMediaChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.image_picker_ios.ImagePickerApi.pickMedia\(channelSuffix)",
            binaryMessenger: binaryMessenger,
            codec: codec
        )
        if let api = api {
            pickMediaChannel.setMessageHandler { message, reply in
                ...
                api.pickMedia(mediaSelectionOptions: mediaSelectionOptionsArg) {
                    result in
                    switch result {
                    case .success(let res):
                        reply(wrapResult(res))
